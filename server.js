...
//stretch 1 add another route to your server. 
app.get('/math_service', function (request, response) { 
  console.log("math_service part");
  ...
  response.write("The value is ");
  console.log("result");
	// Set up a JSON object of the values we want to pass along to the EJS result page
	const params = {operation: op, left: operand1, right: operand2, result: result};
  response.render('public/form.html', params);
})
